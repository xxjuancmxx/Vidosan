            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <li class="active">
                            <a href="#"><i class="fa fa-fw fa-user-md"></i> Mis Pacientes</a>
                        </li>
                    </li>
        </ul>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li >
                                <i class="fa fa-user-md"></i> Mis Pacientes
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" id="tab_pacientes" style="display: none">
                        ...
                        include_once $_SERVER['DOCUMENT_ROOT']."Vidosan/modules/Medicos/DaoMedico/DaoCliente.php";
                         $consul=buscarPacientesporIdmedico($_COOKIE['id']);
                        ...
                        <?php
                          ...
                          ?>
                          <div class="alert alert-warning">No tienes pacientes asignados por ahora..</div>
                          <?php
                        }
