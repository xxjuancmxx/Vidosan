        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <!-- Segundo elemento -->
              <a data-toggle="tooltip" data-placement="top" style="visibility:hidden;">
              </a>
              <!-- Tercer elemento -->
              <a data-toggle="tooltip" data-placement="top" style="visibility:hidden;">
              </a>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/user.png" alt=""><?php echo $_SESSION['nombre_cliente'] . " " . $_SESSION['apellidos']?>
                ...
                <li role="presentation" class="dropdown">
                  ...
                  <!-- Menu desplegable con una preview de los mensajes -->
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                    ...
                    <li>
                      <!-- boton para ver todos los mensajes completos -->
...
<!--
        ...
        -->
          <!-- fila con una columna que ocupa dos filas -->
          <!--
          <div class="row">
            <div class="col-md-4 col-sm-4 col-xs-12">
              <div class="x_panel">
